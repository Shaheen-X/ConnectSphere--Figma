    ...
    <div>
      ...
      <div className="space-y-3">
        {nearbyActivities.map((activity) => (
          <div key={activity.id} className="glass-card p-4 hover:shadow-xl transition-all duration-200">
            <div className="flex space-x-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between mb-2">
                  ...
                  <Badge className="bg-gradient-to-r from-blue-500 to-cyan-400 text-white text-xs border-0 ml-2">
                    {activity.category}
                  </Badge>
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button size="sm" className="bg-gradient-to-r from-blue-500 to-cyan-400 text-white border-0 rounded-full px-4 py-1 text-xs hover:shadow-lg hover:scale-105 transition-all duration-200">
                    Join
                  </Button>
                </div>
              </div>
