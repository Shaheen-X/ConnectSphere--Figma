...
import { Calendar, Clock, MapPin, Users, ChevronRight, Host } from 'lucide-react';
  ...
  if (events.length === 0) {
    return (
      <div className="glass-card p-6 text-center">
        ...
        <Button 
          size="sm" 
          className="bg-gradient-to-r from-blue-500 to-cyan-400 text-white rounded-full px-6 py-2"
        >
          Create Activity
        </Button>
      </div>
