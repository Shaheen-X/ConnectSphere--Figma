  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 glass-card border-b border-white/20 mx-4 mt-4 rounded-2xl shadow-2xl">
        <div className="flex justify-between items-center py-3 px-6">
          ...
          <div className="relative">
            ...
            {showInviteOptions && (
              <div className="absolute top-12 right-0 space-y-2 animate-in fade-in-0 slide-in-from-top-2 duration-200">
            ...
            <Button
              ...
              className={`h-12 w-12 rounded-full text-white border-0 hover:shadow-xl transform hover:scale-110 transition-all duration-300 shadow-xl ${
                showInviteOptions 
      ...
      <Dialog open={showInviteDialog} onOpenChange={setShowInviteDialog}>
        <DialogContent className="sm:max-w-md bg-gradient-to-br from-slate-50 to-gray-100 border-0">
          <DialogHeader>
