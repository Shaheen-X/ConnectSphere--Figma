...
import exampleImageGoals from 'figma:asset/24d5ea91452234034a7573a181e2e631e663b9ad.png';
import exampleImageAbout from 'figma:asset/d44213bcaaac783c71335d09bd18de3a60906a59.png';
import exampleImageActivities from 'figma:asset/2f91e9652d7089c2349e59a496c45ddf921d149f.png';
            ...
            <div className="grid grid-cols-3 gap-3">
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, birthdayMonth: value }))}
                >
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, birthdayDay: value }))}
                >
                  <SelectTrigger className="bg-white border border-gray-200 rounded-xl h-12">
              ...
              <div>
                ...
                <Select 
                  ...
                  onValueChange={(value) => setFormData(prev => ({ ...prev, birthdayYear: value }))}
                >
                  <SelectTrigger className="bg-white border border-gray-200 rounded-xl h-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) => setFormData(prev => ({ ...prev, showGender: checked as boolean }))}
              />
            ...
            <div className="space-y-4">
              <div className="px-4">
                <Slider
                  ...
                  onValueChange={(value) => setFormData({ ...formData, preferredDistance: value })}
                  max={100}
                  min={1}
                  step={1}
                  className="w-full"
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => setFormData({ ...formData, hasPartners: checked })}
              />
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => setFormData({ ...formData, shareContacts: checked })}
              />
            </div>
