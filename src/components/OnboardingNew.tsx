...
import { ChevronRight, ChevronLeft, Eye, EyeOff, Check, X, MapPin, Calendar, Clock, Users, Camera, QrCode, Upload, Search, Mail, User, Phone, Shield, Heart, Target, Zap, Timer, Globe, Plus, Info } from 'lucide-react';
    ...
    return (
      <div className="h-full flex flex-col bg-gradient-to-br from-slate-50 to-gray-100">
        ...
        <div className="p-6 pt-2">
          ...
          <button
            onClick={handleNext}
            disabled={profileSteps[currentStep] === 'Birthday' && formData.birthdayDay && formData.birthdayMonth && formData.birthdayYear && calculateAge(formData.birthdayDay, formData.birthdayMonth, formData.birthdayYear) !== null && calculateAge(formData.birthdayDay, formData.birthdayMonth, formData.birthdayYear)! < 18}
            ...
            <div className="space-y-6">
              <div className="glass-card p-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={formData.hasPartners}
                    onCheckedChange={(checked) => setFormData(prev => ({ ...prev, hasPartners: checked }))}
                  />
                </div>
              </div>
              ...
              <div className="glass-card p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setFormData(prev => ({ ...prev, shareContacts: checked }))}
                  />
                </div>
              ...
              <div className="glass-card p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setFormData(prev => ({ ...prev, allowLocation: checked }))}
              ...
              <div className="glass-card p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setFormData(prev => ({ ...prev, avoidColleagues: checked }))}
              ...
              <div className="glass-card p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setFormData(prev => ({ ...prev, avoidFriendsFamily: checked }))}
